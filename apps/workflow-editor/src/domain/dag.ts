 ...
 * close a cycle in the workflow graph (RF-08, D-06). The graph must remain a
 * DAG at all times — loops are handled by a dedicated Loop node (RF-09), not
 * by a structural back-edge.
 *
